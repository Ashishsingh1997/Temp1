...
if (isset($_POST['submit'])) { 
	...
	$sql= "INSERT INTO product (`name`,`price`,`image`,`category`,`tags`,`color`,`desc`) VALUES('".$name."','".$price."','".$folder."','".$category."','".$tag."','".$color."','".$description."')";
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<?php
								 ...
								 for ($i=1;$i<=$row_count;$i++) {
                                  ...
                                  <input type="checkbox" name="tag[]" value="<?php echo $row["id"]?>"><?php echo $row["name"]?></br>
									<?php
								 }
								 ?>
								...
								<label>Color</label>
								 ...
								 for ($i=1;$i<=$row_count;$i++) {
                                  ...
                                  <input type="checkbox" name="color[]" value="<?php echo $row["id"]?>"><input type="color" value="<?php echo $row["name"] ?>"></br>
									<?php
								 }
								 ?>
